module.exports = {
	name: 'gradient',
	description: 'gradient maker!',
	execute(message, args) {
        	
		if (args.length==3) {message.channel.send("/rename <$"+args[0]+">"+args[1]+"<$"+args[2]+">");} else {
			var word= args[1];
			var i;
			...
			message.channel.send(CommandFinal);
			...
			if (color1.length != 4 && color1.length != 7)
				message.channel.send('colors must be provided as hexes');
